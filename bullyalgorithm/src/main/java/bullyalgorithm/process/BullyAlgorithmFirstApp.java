...
public class BullyAlgorithmFirstApp {
    ...
    public static void up(int up) {
        if (state[up - 1]) {
            ...
            int i;
            BullyAlgorithmFirstApp.state[up - 1] = true;
    ...
    public static void down(int down) {
        if (!state[down - 1]) {
        	...
        	BullyAlgorithmFirstApp.state[down - 1] = false;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; ++i) {
        	BullyAlgorithmFirstApp.state[i] = true;
        }
            ...
            switch (choice) {
                case 1: {
                    ...
                    if (up == 5) {
                        ...
                        BullyAlgorithmFirstApp.state[4] = true;
                        break;
                    }
                    BullyAlgorithmFirstApp.up(up);
                    break;
                }
                case 2: {
                    System.out.println("bring down any process.");
                    int down = sc.nextInt();
                    BullyAlgorithmFirstApp.down(down);
                    break;
                }
                case 3: {
                    System.out.println("which process will send message");
                    int mess = sc.nextInt();
                    BullyAlgorithmFirstApp.mess(mess);
                }
            }
        } while (choice != 4);
    }
